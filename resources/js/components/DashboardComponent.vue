        ...
        <section class="content mt-6">
            <div class="container-fluid">
                <div class="row col-md-12">
                    <div class="col-lg-6">
                        <div class="card ">
                            <div class="card-header custom-header bg-gray-900 border-orange-600">
                                <h3 class="card-title text-yellow text-xl">Phone With Keys GXP-XXXX</h3>
                            </div>
                       <div class="card-body">
                         <div class="row col-md-12">
                            <!-- /.col -->
                            <div class="col-md-6">
                                <div class="card text-white" style="transition: all 0.15s ease 0s; height: inherit; width: inherit;">
                                    ...
                                    <!-- /.card-header -->
                                    <div class="card-body bg-gray-300 text-gray">
                    ...
                    <div class="col-lg-6">
                        <div class="card ">
                            <div class="card-header custom-header bg-gray-900 border-orange-600">
                                <h3 class="card-title text-yellow text-xl">Phone With Keys GRP-XXXX</h3>
                            </div>
                            <div class="card-body">
                                <!-- /.col -->
                                <div class="col-md-6">
